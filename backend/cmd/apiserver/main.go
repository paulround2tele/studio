...
func main() {
	...
	*/
	...
	// REMOVED: Swagger UI; OpenAPI 3.1 spec is maintained at backend/openapi/openapi.yaml
	// if os.Getenv("SWAGGER_ENABLED") == "true" || environment != "production" {
	// 	router.GET("/swagger/*any", ginSwagger.WrapHandler(swaggerFiles.Handler))
	// } else {
	// 	log.Println("Swagger UI disabled in production. Set SWAGGER_ENABLED=true to override.")
	// }
...
// Type aliases for clean OpenAPI generation
type (
	...
	// Proxy types
	Proxy                      = models.Proxy
	CreateProxyRequest         = models.CreateProxyRequest
	UpdateProxyRequest         = models.UpdateProxyRequest
	BulkUpdateProxiesRequest   = models.BulkUpdateProxiesRequest
	BulkDeleteProxiesRequest   = models.BulkDeleteProxiesRequest
	BulkTestProxiesRequest     = models.BulkTestProxiesRequest
	BulkProxyOperationResponse = models.BulkProxyOperationResponse

	// Proxy Pool types
	ProxyPool           = models.ProxyPool
	ProxyPoolMembership = models.ProxyPoolMembership

	// Bulk operation types
	BulkDNSValidationRequest      = models.BulkDNSValidationRequest
	BulkHTTPValidationRequest     = models.BulkHTTPValidationRequest
	BulkValidationResponse        = models.BulkValidationResponse
	BulkResourceRequest           = models.BulkResourceRequest
	BulkResourceResponse          = models.BulkResourceResponse
	BulkOperationStatus           = models.BulkOperationStatus
...
func dumpRoutes() {
	...
	BulkCampaignOperationResponse = models.BulkCampaignOperationResponse
)
