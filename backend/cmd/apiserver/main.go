...
import (
	...
	_ "github.com/fntelecomllc/studio/backend/docs" // Generated docs package for Swagger UI
...
func main() {
	...
	*/
	...
	router.GET("/swagger/*any", ginSwagger.WrapHandler(swaggerFiles.Handler, ginSwagger.URL("/api/openapi.json")))
