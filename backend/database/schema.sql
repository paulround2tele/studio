-- ============================================================================
-- DomainFlow Canonical Schema Snapshot
-- Generated: 2025-09-23T13:04:08Z (UTC)
-- Postgres Version: 16.10 (runtime)
-- Generation Tool: pg_dump 16.10 (schema-only --no-owner --no-privileges)
-- Command: pg_dump --schema-only --no-owner --no-privileges <DSN>
-- IMPORTANT:
--   * This file is for fast bootstrap ONLY. Do not manually edit below.
--   * Always apply migrations in production environments.
--   * Regenerate after adding or changing migrations (./backend/migrate-tool ... then pg_dump).
-- ============================================================================

-- PostgreSQL database dump

\restrict 6pv73gGqKwyQ4Io9NYm1np1QSJYi6c9gMLeh4ByAR9h13OGaXgmQ4hg3JMnDgKL
