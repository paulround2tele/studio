-- Migration 000065: Add "skipped" phase status and refresh sync function logic
BEGIN;

-- Extend phase_status_enum with the new terminal status
ALTER TYPE public.phase_status_enum ADD VALUE IF NOT EXISTS 'skipped' AFTER 'completed';

-- Refresh sync function so campaigns treat skipped phases as terminal successes
