...
export const ProxiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkDeleteProxies: async (bulkDeleteProxiesRequest: BulkDeleteProxiesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bulkDeleteProxiesRequest' is not null or undefined
            assertParamExists('bulkDeleteProxies', 'bulkDeleteProxiesRequest', bulkDeleteProxiesRequest)
         ...
         * @param {BulkTestProxiesRequest} bulkTestProxiesRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bulkTestProxies: async (bulkTestProxiesRequest: BulkTestProxiesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bulkTestProxiesRequest' is not null or undefined
            assertParamExists('bulkTestProxies', 'bulkTestProxiesRequest', bulkTestProxiesRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(bulkTestProxiesRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        bulkUpdateProxies: async (bulkUpdateProxiesRequest: BulkUpdateProxiesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bulkUpdateProxiesRequest' is not null or undefined
            assertParamExists('bulkUpdateProxies', 'bulkUpdateProxiesRequest', bulkUpdateProxiesRequest)
...
export const ProxiesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async bulkDeleteProxies(bulkDeleteProxiesRequest: BulkDeleteProxiesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkProxyOperationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.bulkDeleteProxies(bulkDeleteProxiesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async bulkTestProxies(bulkTestProxiesRequest: BulkTestProxiesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkProxyTestResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.bulkTestProxies(bulkTestProxiesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async bulkUpdateProxies(bulkUpdateProxiesRequest: BulkUpdateProxiesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkProxyOperationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.bulkUpdateProxies(bulkUpdateProxiesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ProxiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        bulkDeleteProxies(bulkDeleteProxiesRequest: BulkDeleteProxiesRequest, options?: RawAxiosRequestConfig): AxiosPromise<BulkProxyOperationResponse> {
            return localVarFp.bulkDeleteProxies(bulkDeleteProxiesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Test multiple proxy configurations simultaneously
         * @summary Bulk test proxies
         ...
         * @throws {RequiredError}
         */
        bulkTestProxies(bulkTestProxiesRequest: BulkTestProxiesRequest, options?: RawAxiosRequestConfig): AxiosPromise<BulkProxyTestResponse> {
            return localVarFp.bulkTestProxies(bulkTestProxiesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Update multiple proxy configurations simultaneously
         * @summary Bulk update proxies
         ...
         * @throws {RequiredError}
         */
        bulkUpdateProxies(bulkUpdateProxiesRequest: BulkUpdateProxiesRequest, options?: RawAxiosRequestConfig): AxiosPromise<BulkProxyOperationResponse> {
            return localVarFp.bulkUpdateProxies(bulkUpdateProxiesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a proxy configuration
         * @summary Delete proxy
...
export class ProxiesApi extends BaseAPI implements ProxiesApiInterface {
     ...
     * @memberof ProxiesApi
     */
    public bulkDeleteProxies(bulkDeleteProxiesRequest: BulkDeleteProxiesRequest, options?: RawAxiosRequestConfig) {
        return ProxiesApiFp(this.configuration).bulkDeleteProxies(bulkDeleteProxiesRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProxiesApi
     */
    public bulkTestProxies(bulkTestProxiesRequest: BulkTestProxiesRequest, options?: RawAxiosRequestConfig) {
        return ProxiesApiFp(this.configuration).bulkTestProxies(bulkTestProxiesRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProxiesApi
     */
    public bulkUpdateProxies(bulkUpdateProxiesRequest: BulkUpdateProxiesRequest, options?: RawAxiosRequestConfig) {
        return ProxiesApiFp(this.configuration).bulkUpdateProxies(bulkUpdateProxiesRequest, options).then((request) => request(this.axios, this.basePath));
    }
