...
export const KeywordExtractionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async streamExtractKeywords(url: string, keywordSetId: string, httpPersonaId?: string, dnsPersonaId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkAnalyzeDomains200Response>> {
...
export const KeywordExtractionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        streamExtractKeywords(url: string, keywordSetId: string, httpPersonaId?: string, dnsPersonaId?: string, options?: RawAxiosRequestConfig): AxiosPromise<BulkAnalyzeDomains200Response> {
