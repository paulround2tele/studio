...
/**
 * Canonical SSE envelope applied to all campaign SSE events.
 * @export
 * @interface CampaignSseEnvelope
 */
export interface CampaignSseEnvelope {
  /**
   * Envelope version emitted by the server (currently 1).
   * @memberof CampaignSseEnvelope
   */
  'version': 
