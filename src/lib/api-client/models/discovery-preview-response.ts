...
// @ts-ignore
import type { DiscoveryPreviewResponseData } from './discovery-preview-response-data';

/**
 * Preview of discovery configuration with lineage information
 * @export
...
export interface DiscoveryPreviewResponse {
  /**
   * 
   * @memberof DiscoveryPreviewResponse
   */
  'success': 
