...
// @ts-ignore
import type { DiscoveryLineageResponseData } from './discovery-lineage-response-data';

/**
 * Discovery lineage for an existing campaign
 * @export
 * @interface DiscoveryLineageResponse
 */
export interface DiscoveryLineageResponse {
  /**
   * 
   * @memberof DiscoveryLineageResponse
   */
  'success': 
