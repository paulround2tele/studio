...
/**
 * Declares which runtime controls are supported for a phase
 * @export
 * @interface PhaseRuntimeControls
 */
export interface PhaseRuntimeControls {
  /**
   * 
   * @memberof PhaseRuntimeControls
   */
  'canPause': 
