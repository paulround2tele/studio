...
// @ts-ignore
import type { RootCauseEvidenceValueOneOf } from './root-cause-evidence-value-one-of';

/**
 * @type RootCauseEvidenceValue
 * @export
 */
export type RootCauseEvidenceValue = Array<string> | RootCauseEvidenceValueOneOf | boolean | number | string;
