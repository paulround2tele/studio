# ModelsHTTPKeywordCampaignParams
...
**lastProcessedDomainName** | **string** |  | [optional] [default to undefined]
...
**proxyPoolId** | [**UuidNullUUID**](UuidNullUUID.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelsHTTPKeywordCampaignParams } from './api';

const instance: ModelsHTTPKeywordCampaignParams = {
    adHocKeywords,
    batchSize,
    keywordSetIds,
