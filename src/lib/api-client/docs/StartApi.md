...
|------------- | ------------- | -------------|
|[**startCampaign**](#startcampaign) | **POST** /{campaignId}/start | Start campaign|

# **startCampaign**
> GetCampaignDetails200Response startCampaign()
...
const apiInstance = new StartApi(configuration);
