# GithubComFntelecomllcStudioBackendInternalModelsDNSValidationCampaignParams
...
```typescript
import { GithubComFntelecomllcStudioBackendInternalModelsDNSValidationCampaignParams } from '@domainflow/api-client';

const instance: GithubComFntelecomllcStudioBackendInternalModelsDNSValidationCampaignParams = {
    batchSize,
    metadata,
    personaIds,
