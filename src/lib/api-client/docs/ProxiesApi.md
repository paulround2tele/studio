...
# **proxiesCreate**
> ProxyDetailsResponse proxiesCreate(createProxyRequestAPI)
...
# **proxiesList**
> Array<ProxyDetailsResponse> proxiesList()
...
# **proxiesUpdate**
> ProxyDetailsResponse proxiesUpdate(updateProxyRequestAPI)
