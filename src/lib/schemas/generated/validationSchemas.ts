...
// Generated on: 2025-06-30T20:45:30.266Z
...
export const httpPersonaConfigSchema = z.object({
  ...
  requestTimeoutSec: z.number().int(),
  ...
  headlessUserAgent: z.string(),
  scriptExecution: z.boolean(),
  loadImages: z.boolean(),
  screenshot: z.boolean(),
  domSnapshot: z.boolean(),
  headlessTimeoutSeconds: z.number().int(),
  waitDelaySeconds: z.number().int(),
  fetchBodyForKeywords: z.boolean(),
});

export type HttpPersonaConfig = z.infer<typeof httpPersonaConfigSchema>;
...
export type DnsPersonaConfig = z.infer<typeof dnsPersonaConfigSchema>;
